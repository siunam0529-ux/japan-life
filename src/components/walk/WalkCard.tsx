...
export function WalkCard({
  ...
  return (
    <article className="relative overflow-hidden rounded-[34px] bg-[#10231A] shadow-[0_24px_55px_rgba(15,23,42,0.22)]">
      <img alt={text.walkAlt(spot.station)} className="h-[440px] w-full object-cover" src={spot.image} />
      ...
      <div className="absolute inset-0 flex flex-col justify-between p-5 text-white">
        <div className="flex items-center justify-between">
          <span className="rounded-full bg-emerald-500/90 px-3 py-1.5 text-xs font-black shadow-lg backdrop-blur-md">{text.todayRecommended}</span>
        ...
        <div className="rounded-[28px] bg-black/12 p-4 shadow-[0_18px_45px_rgba(0,0,0,0.22)] backdrop-blur-[1px]">
          ...
          <p className="mt-5 rounded-2xl bg-black/22 px-3 py-2 text-center text-base font-black leading-7 shadow-inner" style={{ color: "#FFFFFF", textShadow: "0 2px 8px rgba(0,0,0,0.9)" }}>{text.subtitleSentence(spot.subtitle)}</p>
