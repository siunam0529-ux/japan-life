...
const copy = {
  "zh-CN": {
    ...
    sections: [
      ...
      { icon: Landmark, title: "政策福利和官方入口", body: "补助金、支援制度、税金通知、手续入口和政策信息可能因地区、身份、收入、家庭情况和发布日期不同而变化。福利内容可能由系统从官方 RSS 或公开网页抓取，并经过机器翻译或自动整理；翻译和摘要仅供参考，申请前请以政府、自治体或相关机构最新公告为准。" },
  ...
  "zh-TW": {
    ...
    sections: [
      ...
      { icon: Landmark, title: "政策福利和官方入口", body: "補助金、支援制度、稅金通知、手續入口和政策資訊可能因地區、身份、收入、家庭情況和發布日期不同而變化。福利內容可能由系統從官方 RSS 或公開網頁抓取，並經過機器翻譯或自動整理；翻譯和摘要僅供參考，申請前請以政府、自治體或相關機構最新公告為準。" },
