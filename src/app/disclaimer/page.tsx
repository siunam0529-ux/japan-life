...
const copy = {
  "zh-CN": {
    ...
    sections: [
      ...
      { icon: Home, title: "房租、不动产和店铺信息", body: "房租评估、地区对比、外国人友好店铺、优惠和商家信息可能随时间变化。签约、付款、上架、拜访店铺前，请确认官方页面、合同内容、店铺最新公告和现场条件。" },
      { icon: Landmark, title: "政策福利和官方入口", body: "补助金、支援制度、税金通知、手续入口和政策信息可能因地区、身份、收入、家庭情况和发布日期不同而变化。申请前请以政府、自治体或相关机构最新公告为准。" },
    ...
    footerBody: "天气、汇率、节日、地区、优惠、推荐 App、交通和店铺数据可能来自第三方 API、本地整理、Supabase 后台或用户设置，可能出现延迟、遗漏或变更。使用前请再次确认官方来源。",
  },
  "zh-TW": {
    back: "返回",
    title: "免責聲明",
    ...
    sections: [
      ...
      { icon: Home, title: "房租、不動產和店鋪資訊", body: "房租評估、地區對比、外國人友好店鋪、優惠和商家資訊可能隨時間變化。簽約、付款、上架、拜訪店鋪前，請確認官方頁面、合同內容、店鋪最新公告和現場條件。" },
      { icon: Landmark, title: "政策福利和官方入口", body: "補助金、支援制度、稅金通知、手續入口和政策資訊可能因地區、身份、收入、家庭情況和發布日期不同而變化。申請前請以政府、自治體或相關機構最新公告為準。" },
      { icon: BriefcaseBusiness, title: "工作、打工和勞動時間", body: "打工時間、薪資估算和工作限制提醒僅供自我管理。具體勞動條件、在留資格限制、僱用合同和薪資明細請以僱主、學校、入管或勞動相關機構確認結果為準。" },
    ],
    footerTitle: "資料可能延遲或不完整",
    footerBody: "天氣、匯率、節日、地區、優惠、推薦 App、交通和店鋪資料可能來自第三方 API、本地整理、Supabase 後台或使用者設定，可能出現延遲、遺漏或變更。使用前請再次確認官方來源。",
  },
  ja: {
    back: "戻る",
    title: "免責事項",
    ...
    warningBody: "本 App の金銭、税務、ビザ、在留、医療、家賃、政策支援に関する内容は参考と概算であり、法律、税務、医療、投資、不動産、行政手続きの助言ではありません。",
    sections: [
      ...
      { icon: Home, title: "家賃、不動産、店舗情報", body: "家賃評価、エリア比較、外国人にやさしい店舗、特典、店舗情報は変わる場合があります。契約、支払い、掲載申請、来店前には公式ページ、契約内容、最新案内、現地条件を確認してください。" },
      { icon: Landmark, title: "政策支援と公式入口", body: "補助金、支援制度、税金通知、手続き入口、政策情報は地域、在留状況、収入、世帯、公開日により変わります。申請前に政府、自治体、関連機関の最新案内を確認してください。" },
    ...
    footerBody: "天気、為替、祝日、地域、特典、おすすめ App、交通、店舗データは第三者 API、ローカル整理、Supabase 管理画面、ユーザー設定に基づく場合があり、遅延、欠落、変更が起こる可能性があります。利用前に公式情報を再確認してください。",
  },
} as const;
