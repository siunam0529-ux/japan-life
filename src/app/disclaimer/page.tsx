...
const copy = {
  ...
  "zh-TW": {
    ...
    sections: [
      ...
      { icon: Home, title: "房租、不動產和店鋪資訊", body: "房租評估、地區對比、外國人友好店鋪、優惠和商家資訊可能隨時間變化。簽約、付款、上架、拜訪店鋪前，請確認官方頁面、合約內容、店鋪最新公告和現場條件。" },
  ...
  ja: {
    ...
    sections: [
      ...
      { icon: HeartPulse, title: "医療、保険、緊急情報", body: "病院、保険、急病、災害、緊急連絡先の情報は入口検索と生活参考用です。体調不良、緊急時、医療判断が必要な場合は医療機関、救急、専門家へすぐ相談してください。" },
