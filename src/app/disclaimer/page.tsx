...
const copy = {
  "zh-CN": {
    ...
    footerBody: "天气、汇率、节日、地区、交通票券、推荐 App、交通、政策福利和店铺数据可能来自第三方 API、官方公开网页、本地整理、Supabase 后台或用户设置，可能出现延迟、遗漏、误译或变更。使用前请再次确认官方来源。",
  },
  "zh-TW": {
    back: "返回",
    title: "免責聲明",
    ...
    footerBody: "天氣、匯率、節日、地區、交通票券、推薦 App、交通、政策福利和店鋪資料可能來自第三方 API、官方公開網頁、本地整理、Supabase 後台或使用者設定，可能出現延遲、遺漏、誤譯或變更。使用前請再次確認官方來源。",
  },
  ja: {
    back: "戻る",
    title: "免責事項",
    ...
    sections: [
      ...
      { icon: Home, title: "家賃、不動産、店舗情報", body: "家賃評価、エリア比較、店舗、予約情報、店舗情報は変わる場合があります。契約、支払い、掲載申請、来店前には公式ページ、契約内容、最新案内、現地条件を確認してください。" },
    ...
    footerBody: "天気、為替、祝日、地域、交通チケット、おすすめ App、交通、政策支援、店舗データは第三者 API、公式公開ページ、ローカル整理、Supabase 管理画面、ユーザー設定に基づく場合があり、遅延、欠落、誤訳、変更が起こる可能性があります。利用前に公式情報を再確認してください。",
  },
} as const;
