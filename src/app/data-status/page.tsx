...
const copy = {
  "zh-CN": {
    ...
    feedback: "发现数据不准？去反馈",
    items: [
      { icon: TrainFront, title: "东京交通 / 车站", status: "ODPT API", body: "东京交通状态、东京都车站搜索和租屋车站选择优先使用 ODPT。数据可能与铁路公司公告存在延迟或差异。", live: true },
      { icon: Store, title: "吃喝 / 美容美发店铺", status: "HotPepper API", body: "今天吃什么，以及 HotPepper 覆盖的吃喝美容美发类别优先走 HotPepper。", live: true },
      ...
      { icon: Database, title: "随机散步 / 今天去哪玩", status: "本地目的地", body: "目的地推荐是 Japan Life 本地整理，用于轻量参考；出发前请用地图和官方信息再次确认。", live: false },
  ...
  "zh-TW": {
    ...
    feedback: "發現資料不準？去回饋",
    items: [
      { icon: TrainFront, title: "東京交通 / 車站", status: "ODPT API", body: "東京交通狀態、東京都車站搜尋和租屋車站選擇優先使用 ODPT。資料可能與鐵路公司公告存在延遲或差異。", live: true },
      { icon: Store, title: "吃喝 / 美容美髮店鋪", status: "HotPepper API", body: "今天吃什麼，以及 HotPepper 覆蓋的吃喝美容美髮類別優先走 HotPepper。", live: true },
      ...
      { icon: Database, title: "隨機散步 / 今天去哪玩", status: "本地目的地", body: "目的地推薦是 Japan Life 本地整理，用於輕量參考；出發前請用地圖和官方資訊再次確認。", live: false },
  ...
  ja: {
    ...
    items: [
      { icon: TrainFront, title: "東京交通 / 駅", status: "ODPT API", body: "東京の運行情報、東京都の駅検索、家賃ツールの駅選択は ODPT を優先します。鉄道会社の発表と差異や遅延がある場合があります。", live: true },
      { icon: Store, title: "飲食 / 美容店舗", status: "HotPepper API", body: "今日の食事、HotPepper 対象の飲食・美容カテゴリは HotPepper を優先します。", live: true },
      ...
      { icon: Database, title: "ランダム散歩 / 今日のお出かけ", status: "ローカル目的地", body: "目的地は Japan Life がローカル整理した軽い参考情報です。出発前に地図や公式情報を確認してください。", live: false },
