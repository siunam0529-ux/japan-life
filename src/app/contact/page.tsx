...
const copy = {
  "zh-CN": {
    title: "反馈与合作",
    subtitle: "如果你在使用 Japan Life 时发现内容错误、功能不好用，或想进行店铺推荐、实用 App 推荐、内容合作，都可以通过下面的方式联系我。",
    feedbackTitle: "反馈",
    feedbackBody: "欢迎告诉我哪里看不清、哪里不好用、哪些工具还缺功能。越具体越好，例如页面名称、遇到的问题、希望怎么改。",
    collaborationTitle: "合作",
    collaborationBody: "如果你有在日生活相关服务、店铺、实用 App 或内容资源，想放进 Japan Life，可以直接联系我说明合作方式。",
    contactTitle: "我的联系方式",
    formTitle: "快速反馈",
    pageLabel: "页面 / 功能",
    typeLabel: "问题类型",
    ...
    savedLocal: "已先暂存反馈。感谢你补充细节，我会尽快确认。",
    submitting: "提交中...",
    types: ["数据不准", "页面显示问题", "功能不好用", "店铺 / App 信息", "其他"],
  },
  "zh-TW": {
    title: "回饋與合作",
    subtitle: "如果你在使用 Japan Life 時發現內容錯誤、功能不好用，或想進行店鋪推薦、實用 App 推薦、內容合作，都可以透過下面的方式聯絡我。",
    feedbackTitle: "回饋",
    feedbackBody: "歡迎告訴我哪裡看不清、哪裡不好用、哪些工具還缺功能。越具體越好，例如頁面名稱、遇到的問題、希望怎麼改。",
    collaborationTitle: "合作",
    collaborationBody: "如果你有在日生活相關服務、店鋪、實用 App 或內容資源，想放進 Japan Life，可以直接聯絡我說明合作方式。",
    contactTitle: "我的聯絡方式",
    formTitle: "快速回饋",
    pageLabel: "頁面 / 功能",
    typeLabel: "問題類型",
    ...
    savedLocal: "已先暫存回饋。謝謝你補充細節，我會盡快確認。",
    submitting: "提交中...",
    types: ["資料不準", "頁面顯示問題", "功能不好用", "店鋪 / App 資訊", "其他"],
  },
  ja: {
    title: "フィードバック・提携",
    subtitle: "Japan Life の内容修正、使いにくい点、店舗掲載、App 掲載、コンテンツ提携などは、下記からお気軽にご連絡ください。",
    feedbackTitle: "フィードバック",
    feedbackBody: "見づらい箇所、使いにくい機能、追加してほしいツールなどを教えてください。ページ名、問題点、改善希望があると助かります。",
    collaborationTitle: "提携",
    collaborationBody: "日本生活に関するサービス、店舗、便利な App、情報コンテンツを Japan Life に掲載したい場合は、提携内容を添えてご連絡ください。",
    contactTitle: "連絡先",
    ...
    savedLocal: "フィードバックを一時保存しました。詳しい内容をありがとうございます。確認します。",
    submitting: "送信中...",
    types: ["データが違う", "表示の問題", "使いにくい", "店舗 / App 情報", "その他"],
  },
} as const;
