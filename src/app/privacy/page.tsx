...
const copy = {
  ...
  "zh-TW": {
    back: "返回",
    title: "隱私政策",
    subtitle: "說明 Japan Life 如何處理帳號、定位、通知、本機資料、雲端同步與後台提交。",
    importantTitle: "重要說明",
    importantBody:
    ...
    sections: [
      ...
      { icon: Bell, title: "通知權限", body: "通知功能使用瀏覽器 Notification API 和 Service Worker，用於垃圾日、繳費、節日、在留卡等生活提醒。通知權限只會在你主動開啟時申請。" },
  ...
  ja: {
    ...
    sections: [
      ...
      { icon: Bell, title: "通知権限", body: "通知はブラウザの Notification API と Service Worker を使い、ごみの日、支払い、祝日、在留カードなどの生活リマインダーに利用します。マーケティング通知は送信しません。" },
