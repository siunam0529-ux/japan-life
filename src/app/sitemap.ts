...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: createCanonicalUrl("/community/zh-cn"), lastModified: now, changeFrequency: "daily", priority: 0.82 },
    { url: createCanonicalUrl("/community/zh-tw"), lastModified: now, changeFrequency: "daily", priority: 0.82 },
    { url: createCanonicalUrl("/community/ja"), lastModified: now, changeFrequency: "daily", priority: 0.82 },
