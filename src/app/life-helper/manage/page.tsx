...
const zhTwManageCopy = {
  ...zhCnManageCopy,
  badge: "生活幫手",
  loading: "正在讀取你的生活幫手管理資料...",
  loadFail: "管理資料讀取失敗。",
  loginTitle: "管理發布需求和服務",
  loginDesc: "登入後可以管理你發布的需求、申請記錄和服務入駐狀態。",
  login: "去登入",
  title: "管理發布需求和服務",
  desc: "集中查看你的需求、申請和服務入駐狀態。",
  statRequests: "發布需求",
  statReceived: "收到申請",
  statServices: "服務申請",
  publishRequest: "發布需求",
  ...
  tabRequests: "我的需求",
  tabApplications: "我的申請",
  tabServices: "服務入駐",
  emptyRequests: "你還沒有發布過需求。",
  emptyApplications: "你還沒有申請過別人的需求。",
  emptyServices: "你還沒有提交服務入駐申請。",
  closed: "已關閉",
  receivedCount: (count: number) => "收到 " + count + " 個申請",
  viewDetail: "查看詳情",
  closeRequest: "關閉需求",
  reopenRequest: "重新開放",
  deletedRequest: "需求可能已經刪除",
  viewRequest: "查看需求",
  businessService: "商家服務",
  personalHelper: "個人幫手",
} as const;
...
const jaManageCopy = {
  ...
  back: "戻る",
  badge: "暮らしサポート",
  loading: "暮らしサポートの管理データを読み込んでいます...",
  loadFail: "管理データの読み込みに失敗しました。",
  loginTitle: "依頼とサービスを管理",
  loginDesc: "ログインすると、自分の依頼、応募履歴、サービス登録状況を管理できます。",
  login: "ログイン",
  eyebrow: "管理",
  title: "依頼とサービスを管理",
  desc: "自分の依頼、応募、サービス登録状況をまとめて確認できます。",
  statRequests: "投稿した依頼",
  statReceived: "届いた応募",
  statServices: "サービス申請",
  publishRequest: "依頼を投稿",
  manageServices: "サービス管理",
  requestClosed: "依頼を締め切りました。",
  requestReopened: "依頼を再開しました。",
  requestUpdateFail: "依頼ステータスの更新に失敗しました。",
  tabRequests: "自分の依頼",
  tabApplications: "自分の応募",
  tabServices: "サービス登録",
  emptyRequests: "投稿した依頼はまだありません。",
  emptyApplications: "他の依頼への応募はまだありません。",
  emptyServices: "サービス登録申請はまだありません。",
  recruiting: "募集中",
  closed: "締切済み",
  receivedCount: (count: number) => count + "件の応募",
  viewDetail: "詳細を見る",
  closeRequest: "依頼を締切",
  reopenRequest: "再開する",
  deletedRequest: "依頼が削除された可能性があります",
  viewRequest: "依頼を見る",
  businessService: "事業者サービス",
  personalHelper: "個人サポーター",
} as const;

const manageCopy = { "zh-CN": zhCnManageCopy, "zh-TW": zhTwManageCopy, ja: jaManageCopy } as const;
