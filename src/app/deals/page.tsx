...
import { ArrowLeft, BadgePercent, BriefcaseBusiness, ChevronRight, CreditCard, Home, Search, Send, ShoppingBag, Smartphone, Star, WalletCards, Wifi, X } from "lucide-react";
import Link from "next/link";
import { useMemo, useState } from "react";
import { BottomNav } from "@/components/BottomNav";
import { DataNotice } from "@/components/DataNotice";
import { dealItems, type DealCategory, type DealItem } from "@/data/deals";
  ...
  return (
    <main className="min-h-screen bg-[#f5f0e7] text-stone-950">
      <div className="mx-auto min-h-screen max-w-[430px] bg-[#fbf8f2] px-4 pb-4 pt-4 shadow-2xl shadow-stone-300/40">
        ...
        <DataNotice
          source="Japan Life 本地优惠/推广资料"
          sourceZhTW="Japan Life 本地優惠/推廣資料"
          updatedAt="2026-05-22"
          note="优惠、佣金、推广关系和有效期可能变化；申请、付款或签约前请以商家/官方页面为准。"
          noteZhTW="優惠、佣金、推廣關係和有效期可能變化；申請、付款或簽約前請以商家/官方頁面為準。"
        />
        <BottomNav />
      </div>
    </main>
