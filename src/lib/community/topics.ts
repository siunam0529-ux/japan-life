...
export const communityHotTopics: Record<CommunityViewLocale, string[]> = {
  ...
  ja: ["池袋グルメ", "東京散歩", "部屋探し", "バイト日本語", "節約生活", "引っ越し", "友達募集", "ペット生活", "割引情報", "一人ごはん"],
  "zh-cn": ["池袋美食", "东京散步", "租房避坑", "打工日语", "省钱生活", "搬家出清", "同城搭子", "宠物生活", "折扣福利", "一人食"],
  "zh-tw": ["池袋美食", "東京散步", "租屋避伏", "打工日文", "慳錢生活", "搬屋清物", "同城搭子", "寵物生活", "折扣福利", "一人食"],
};
